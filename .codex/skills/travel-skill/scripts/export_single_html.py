...
def inline_assets(guide_root: Path, layer: str, device: str = "desktop") -> str:
    ...
    html = html.replace('<link rel="stylesheet" href="../../assets/base.css" />', f"<style>\n{css}\n</style>")
...
def main() -> None:
    ...
    output_path.write_text(inline_assets(guide_root, args.layer, args.device), encoding="utf-8")
