...
def inline_assets(guide_root: Path, layer: str) -> str:
    desktop_html = (guide_root / "desktop" / layer / "index.html").read_text(encoding="utf-8")
...
def main() -> None:
    ...
    output_path.write_text(inline_assets(guide_root, args.layer), encoding="utf-8")
